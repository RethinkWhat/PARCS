...
public class HistoryPageView extends JFrame{
    ...
    public HistoryPageView(){
        ...
        //panelCards for our beloved customer list
    ...
    private void components(){
        ...
        jLayeredPane.setForeground(new java.awt.Color(153, 153, 153));
        ...
        getContentPane().add(jPanel1, java.awt.BorderLayout.CENTER); // fixed this
        pack();
    }
